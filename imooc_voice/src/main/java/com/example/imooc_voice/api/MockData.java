...
public class MockData {
    ...
    public static final String FRIEND_DATA = "{\n"
            ...
            + "        \"zan\": \"23s4\",\n"
            + "        \"msg\": \"5d6\",\n"
            + "        \"videoUrl\": \"https://www.apple.com/105/media/cn/iphone-x/2017/01df5b43-28e4-4848-bf20-490c34a926a7/films/feature/iphone-x-feature-cn-20170912_1280x720h.mp4\",\n"
            + "        \"audioBean\": {\n"
            + "          \"id\": \"100006\",\n"
            ...
            + "      {\n"
            + "        \"type\": 1,\n"
            + "        \"avatr\": \"https://t7.baidu.com/it/u=2168645659,3174029352&fm=193&f=GIF\",\n"
            + "        \"name\": \"朱康伟\",\n"
            + "        \"fans\": \"3213\",\n"
